...
public interface MemberMapper {
	...
	@Select("SELECT MEMBER_NO memberNo, MEMBER_ID memberId, MEMBER_PW memberPw, MEMBER_NAME memberName, ROLE role FROM TB_BOOT_MEMBER WHERE MEMBER_ID = #{memberId}")
	...
	int updatePassword(Map<String, Object> updateRequest);
